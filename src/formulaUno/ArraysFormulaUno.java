...
class ArrayCoche {
	...
	public void destruirCoche(Coche coche) {
		...
		} else { // garaje vac韔 no hay q buscar para eliminar
			System.out.println("Garaje vac铆o, no se puede encontrar el coche");
		}
...
class ArrayMecanico {
	...
	public void despedirMecanico(Mecanico mecanico) {
		if (numElem > 0) {
			...
			System.out.println("Staff vac铆o, no se puede encontrar el mecanico");
		}
...
class ArrayPiloto {
	...
	public void despedirPiloto(Piloto piloto) {
		if (numElem > 0) {
			...
			System.out.println("Staff vac铆o, no se puede encontrar el piloto");
		}
